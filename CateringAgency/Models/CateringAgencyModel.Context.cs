...
namespace CateringAgency.Models
{
    ...
    public partial class CateringAgencyEntities : DbContext
    {
        public CateringAgencyEntities()
            : base("name=CateringAgencyEntities")
        {
        }
        ...
        public virtual DbSet<combo_menu> combo_menu { get; set; }
        public virtual DbSet<combo_menu_item> combo_menu_item { get; set; }
        ...
        public virtual DbSet<order_food_item> order_food_item { get; set; }
